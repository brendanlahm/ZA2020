############ Machine learning script for predicting PAV of contig6
...
###################### PAV Data
PAV = pd.read_csv("./ZA2020/data/PAV_isolates36.csv")
df2 = pd.merge(df, PAV, on="Isolate")
...
### Select Agropyron sp. as Host & 2011 as Year
predicted_contig6 = regr.predict([[1, 0, 0, 0, 1, 0]])
print(predicted_contig6)

z = predicted_contig6 * 100
print("Probability of having contig6: " + z[0].astype(str)[0:2] + "%")
print("Note: This model is not a great fit & this script is purely for exploring the data.")
