...
/groups/envgenom/Brendan_Lahm/Data/1_Filtered_reads/200408/${each%_aln.sai}.fq /groups/envgenom/Brendan_Lahm/Data/1_Filtered_reads/200408/${each%1P_aln.sai}2P.fq \
