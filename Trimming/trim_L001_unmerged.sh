...
ZA020_L001.unassembled.forward.fastq \
ZA020_L001.unassembled.reverse.fastq \
-baseout /groups/envgenom/Brendan_Lahm/Data/1_Filtered_reads/ZA020/L001/ZA020_L001_unassembled_trim.fq.gz \
